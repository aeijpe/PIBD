...
def _process_args():
    ...
    parser.add_argument('--label_dir', type=str, default="../MMP/src/splits/survival", help='Path to csv with labels')
    ...
    parser.add_argument('--num_patches', type=int, default=512, help='number of patches')
    parser.add_argument('--label_col', type=str, default="dss_survival_days", help='type of survival (OS, DSS, PFI)')
    ...
    parser.add_argument('--bag_loss', type=str, choices=["nll_surv", "rank_surv", "cox_surv", "cox_surv_mmp"], default='nll_surv',
